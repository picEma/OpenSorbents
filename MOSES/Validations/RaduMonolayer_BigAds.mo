...
/*
  ...
  */
  ...
  parameter Real n = 1;
  parameter Loading Wi =0.04691; //Des= 0.12276; //Ads=0.04691;
  parameter Loading DWmax =0.07505; //Des= -0.07568; //Ads=0.07505;
  parameter Temperature Ti_particle =323.15; //Des= 331.15; //Ads=323.15;
  parameter Real parGamma = 0.12;
  parameter Real t0=10;
  Integer index(start=1, fixed=true);
  parameter Length radius=0.0004;
  parameter MassConcentration ci =0.00595 "fake initial concentration parameter used in Carslaw model to determine the transient state, in such a way that it is as close as possible to the single step approximation"; //ads=0.00595, des= 0.0284

 ///////////////////////////////////////////////////////////////////////////////////////////////////
 
  //Validation Metrics
   
  Real[19] rExp "normalized loading in Radu et al";
  //Des
  /*
  ...
  */
  ...
  Components.Boundaries.TRamp_HeatBoundary tRamp_HeatBoundary(Tf(displayUnit = "K") = 303.15, Ti(displayUnit = "K") = 303.15, tRamp = 10) annotation(
    Placement(visible = true, transformation(origin = {-82, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
 
  //for ads=303.15, des 353.15
  
  //external vapor is considered to be saturated steam at temperature (30°C)
  MOSES.Components.Boundaries.PT_FluidBoundary pT_FluidBoundary(Psat = 880, T = 303.15) annotation(
