...
model RaduMonolayer_SmallAds
  //Settings
  parameter Real n = 1;
  parameter Loading Wi = 0.04691;
  //Des= 0.12276; //Ads=0.04691;
  parameter Loading DWmax = 0.07505;
  //Des= -0.07568; //Ads=0.07505;
  parameter Temperature Ti_particle = 323.15;
  //Des= 331.15; //Ads=323.15;
  parameter Real parGamma = 0.07;
  parameter Real t0 = 10;
  Integer index(start = 1, fixed = true);
  parameter Length radius = 0.0002;
  parameter MassConcentration ci = 0.00595 "fake initial concentration parameter used in Carslaw model to determine the transient state, in such a way that it is as close as possible to the single step approximation";
